// Code generated by protoc-gen-go-storage. DO NOT EDIT.
// versions:
// - protoc-gen-go-storage v1.5.1
// - protoc             v5.27.1
...
// is compatible with the storage package it is being compiled against.
...
// It's only intended for direct use with storage.RegisterService,
